...
const Login = () => {
  ...
  const clientId =
    '919232815715-f70glq27uqpdg0bo2h8f9paff5aj1dq0.apps.googleusercontent.com'
  const clientSecret = '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'
      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={12} md={7} lg={7}>
            <ResponsiveForm
              sx={{ marginTop: '150px', width: '400px' }}
              elevation={0}
            >
              <Formik
          ...
          <Responsive item xs={12} sm={12} md={3} lg={3}>
            <Box
              component="img"
              sx={{
                height: 600,
